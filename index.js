...
export default class DaumMapView extends Component {
    ...
    if (this.state.permissionGranted) {
      return (
        <DaumMap
          ...
          onZoomLevelChange={this._onZoomLevelChange}
  ...
  _onZoomLevelChange = (event) => {
    if (this.props.onZoomLevelChange != undefined) {
      this.props.onZoomLevelChange(event.nativeEvent);
    }
  };
